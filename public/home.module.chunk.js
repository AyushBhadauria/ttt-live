...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.onSubmit = function () {
        var _this = this;
        this.loading = true;
        this.dataService.getPosts(this.count).subscribe(function (data) {
            _this.response = data;
            _this.loading = false;
        });
    };
    ...
    HomeModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* RouterModule */].forChild(routes),
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__service_data_service__["a" /* DataService */]]
        })
    ], HomeModule);
    return HomeModule;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_endpoint__ = __webpack_require__("../../../../../src/app/shared/endpoint.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getPosts = function (count) {
        ;
        return this.http.get(__WEBPACK_IMPORTED_MODULE_3__shared_endpoint__["a" /* Endpoint */].api + '/' + count)
